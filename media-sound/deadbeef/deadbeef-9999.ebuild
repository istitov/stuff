...
inherit autotools flag-o-matic git-r3 plocale toolchain-funcs xdg
...
src_prepare() {
	...
	if ! grep -q 'AC_ARG_ENABLE(mpris' configure.ac; then
		eapply "${FILESDIR}"/${PN}-1.10.2-mpris-toggle.patch
	fi
