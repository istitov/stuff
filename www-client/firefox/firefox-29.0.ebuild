...
# $Header: /var/cvsroot/gentoo-x86/www-client/firefox/firefox-29.0.ebuild,v 1.1 2014/05/01 13:27:03 anarchy Exp $
...
IUSE="bindist gstreamer hardened +jit +minimal pgo pulseaudio selinux system-cairo system-icu system-jpeg system-sqlite test appmenu"
...
RDEPEND="
	...
	appmenu? ( >=x11-libs/gtk+-2.8.6:2[appmenu] )"
...
src_prepare() {
	...
	if use appmenu;then
		epatch "${FILESDIR}/${PV}/unity-menubar.patch.bz2"
	fi
