...
# $Header: /var/cvsroot/gentoo-x86/www-client/chromium/chromium-15.0.849.0.ebuild,v 1.1 2011/08/12 23:29:22 phajdan.jr Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-system-libevent-r2.patch"
