...
pkg_postinst() {
	...
	elog "6.17.13 (full coverage — 6.17 ended at .13) via Gentoo's genpatches,"
	elog "plus a curated subset of natalenko's pf-kernel delta. 6.17 is an EOL"
	...
	elog "are dropped in favour of stable."
	elog ""
	elog "For pf-kernel's full patchset, install pf-sources-6.17_p4-r1 instead —"
