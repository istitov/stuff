...
pkg_postinst() {
	...
	elog "6.15.11 via Gentoo's genpatches, plus a curated subset of natalenko's"
	elog "pf-kernel delta. 6.15 is an EOL non-LTS branch (linux-stable ended at"
	elog "6.15.12, one release past genpatches' last bundle) — no further"
	elog "linux-stable backports will arrive."
	elog ""
	...
	elog ""
	elog "For pf-kernel's full patchset, install pf-sources-6.15_p6-r1 instead —"
