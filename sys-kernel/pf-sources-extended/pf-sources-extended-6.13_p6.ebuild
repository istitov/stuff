...
# EOL 6.13 is fully covered through 6.13.12. Exclude the 5010 CPU and optional
# BMQ/PDS patches. Drop pf's arch/x86 changes because they revert stable
# KASAN/Rust/EISA/microcode, MGEODE, and GCC 15 CSTD fixes; retain vanilla x86
# family selection.
...
# Use an immutable extra-stuff snapshot of alicef's genpatches trunk; refreshes
# require a new tag suffix.
...
pkg_postinst() {
	...
	elog "6.13.12 (full coverage — 6.13 ended at .12) via alicef's genpatches"
	elog "trunk, plus a curated subset of natalenko's pf-kernel delta. 6.13 is"
	...
	elog "levels are NOT included on this branch — keeping stable's arch/x86"
	elog "improvements means vanilla x86 family selection."
	elog ""
	...
	elog "install pf-sources-6.13_p6-r1 instead — it stays GA-frozen and still"
