...
pkg_postinst() {
	...
	elog "6.3.9 via Gentoo's genpatches, plus a curated subset of natalenko's"
	elog "pf-kernel delta. 6.3 is an EOL non-LTS branch — no further linux-stable"
	...
	elog ""
	elog "For pf-kernel's full patchset, install pf-sources-6.3_p5-r1 instead —"
