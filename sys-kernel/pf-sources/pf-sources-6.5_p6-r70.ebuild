...
# linux-stable backport chain (1000_…1012_) covers 6.5.1 through 6.5.13.
GENPATCHES_STABLE=(
...
# Non-stable genpatches additions. 5010 is included per-branch judgment;
# 5020 BMQ scheduler is intentionally excluded (see note at top of file).
GENPATCHES_EXTRA=(
...
src_prepare() {
	...
	eapply "${FILESDIR}/pf-curated-6.5"/*.patch
