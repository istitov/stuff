...
src_prepare() {
	...
	# picks up linux-stable, so 6.16-pfN ships unpatched 6.16.0 source.
	...
	# validation. 6.16 has no linux-stable continuation; pf-kernel
	# 6.16.0 is the relevant base. Same GA-only gap as 31431.
