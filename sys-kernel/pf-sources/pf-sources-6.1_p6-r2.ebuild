...
src_prepare() {
	...
	# CVE-2026-31431: algif_aead local privilege escalation. Its 6.1.170
	# stable backport does not apply to GA-based -pf; carry the affected crypto
	# files cumulatively through 6.1.170.
	eapply "${WORKDIR}/pf-cves-cumulative-6.1/cve-2026-31431-algif_aead-cumulative-6.1.patch"

	# CVE-2026-43037/43038: IPv6 cb[] confusion causing an OOB write/read.
	# The 6.1.168 fixes do not apply to GA-based -pf; carry the affected IPv6
	# files cumulatively through 6.1.170.
	eapply "${WORKDIR}/pf-cves-cumulative-6.1/cve-2026-43037-43038-cumulative-6.1.patch"
