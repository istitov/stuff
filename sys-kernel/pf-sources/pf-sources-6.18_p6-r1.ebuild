...
src_prepare() {
	...
	# picks up linux-stable, so 6.18-pfN ships unpatched 6.18.0 source.
	...
	# validation. Backported into 6.18.22; same GA-only gap as 31431.
	...
	# IP6CB(skb2). Backported into 6.18.22; same GA-only gap.
