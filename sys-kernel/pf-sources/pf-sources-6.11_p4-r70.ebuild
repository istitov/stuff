...
# linux-stable backport chain (1000_…1010_) covers 6.11.1 through 6.11.11.
GENPATCHES_STABLE=(
...
GENPATCHES_EXTRA=(
	...
	2951_libbpf-Prevent-compiler-warnings-errors.patch
	2952_resolve-btfids-Fix-compiler-warnings.patch
	2980_GCC15-gnu23-to-gnu11-fix.patch
	2990_libbpf-v2-workaround-Wmaybe-uninitialized-false-pos.patch
	2991_libbpf-workaround-Wmaybe-uninitialized-false-pos.patch
	2995_dtrace-6.11_p1.patch
	2996_kbuild-bpf-jobs-val-pahole-fix.patch
...
src_prepare() {
	...
	eapply "${FILESDIR}/pf-curated-6.11"/*.patch
	default
}
