...
# flag needed. The 0.6.x cute-DSL requirement is
# nvidia-cutlass-dsl==4.6.0, matched by the floor below -- the JIT'd
# kernels are ABI-locked to the DSL version. # verified 2026-07-05
# against 0.6.1.
RDEPEND="
