...
SRC_URI="
	https://files.pythonhosted.org/packages/64/e0/89529bc5e6de73f49e8ac53dccef8c2925b75286daae186693468afb4533/${P}-py3-none-manylinux2014_x86_64.whl
"
S="${WORKDIR}"
...
# (verified 2026-05-16 against 1.1.{3,4,5} and 2026-06-10 against
# 1.1.6 — byte-identical loader.py across all of them),
