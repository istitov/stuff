...
# vllm 0.24.0 ships a Rust frontend binary (vllm-rs) built via
...
VLLM_DEEPGEMM_COMMIT="891d57b4db1071624b5c8fa0d1e51cb317fa709f"
...
VLLM_FMHA_SM100_COMMIT="fee783153f3efe57e3e933c5cb7e267a7cebcfb5"
...
#
# humming-kernels[cu13] (requirements/cuda.txt, ==0.1.6 "for quantization
...
RDEPEND="
	...
	cuda? (
		...
		humming? ( ~dev-python/humming-kernels-0.1.6[${PYTHON_SINGLE_USEDEP}] )
		$(python_gen_cond_dep '
...
# Tests need a model and inference setup; not wired up here.
RESTRICT="test"
