...
# Importing fastsafetensors imports torch unconditionally.  Tqdm is optional,
# while Typer is listed in upstream metadata but has no import or entry point.
# verified 2026-08-04 against 0.3.2.
RDEPEND="
...
pkg_postinst() {
	...
	optfeature "ROCm support" dev-util/hip
