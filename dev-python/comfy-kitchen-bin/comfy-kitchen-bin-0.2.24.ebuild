...
SRC_URI="
	cuda? ( https://files.pythonhosted.org/packages/f6/d4/aac38655a7b5df92989940888a9b2c6e88a9234644b8d0f775a2eacffacc/comfy_kitchen-${PV}-cp312-abi3-manylinux_2_24_x86_64.manylinux_2_28_x86_64.whl )
	!cuda? ( https://files.pythonhosted.org/packages/83/5f/041dcabe870f4d6e372e92251a5d68f87be542cb937eeb60e24ea24cea0f/comfy_kitchen-${PV}-py3-none-any.whl )
"
S="${WORKDIR}"
