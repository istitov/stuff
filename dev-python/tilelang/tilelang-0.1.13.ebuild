...
#
# 0.1.13 pins apache-tvm-ffi>=0.1.11,<0.1.13 (0.1.12 had <=0.1.11). tvm-ffi is
# the FFI ABI tilelang binds against — unlike the loose z3 cap below, this
# one is load-bearing. ::stuff carries apache-tvm-ffi-0.1.12 and 0.1.13_p0;
# <0.1.13 excludes the post-release (0.1.13.post0 > 0.1.13) and lands the
# resolver on 0.1.12. # verified 2026-08-03 against 0.1.13.
RDEPEND="
