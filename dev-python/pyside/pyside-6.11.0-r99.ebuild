...
# Fork of ::gentoo's dev-python/pyside-6.11.0 that adds a `datavis`
...
# dev-qt/qtdatavis3d-6.11.0 ebuild.
...
if [[ ${PV} == *.9999 ]]; then
	...
	# (overlay-only) and dev-qt/qtgraphs (::gentoo) at 6.11.0 are ~amd64-only,
