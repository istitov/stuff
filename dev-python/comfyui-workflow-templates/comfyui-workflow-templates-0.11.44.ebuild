...
RDEPEND="
	~dev-python/comfyui-workflow-templates-core-0.3.315[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-json-0.1.50[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-api-0.3.84[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-assets01-0.1.30[${PYTHON_SINGLE_USEDEP}]
