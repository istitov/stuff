...
RDEPEND="
	~dev-python/comfyui-workflow-templates-core-0.3.322[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-json-0.1.57[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-api-0.3.84[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-assets01-0.1.35[${PYTHON_SINGLE_USEDEP}]
