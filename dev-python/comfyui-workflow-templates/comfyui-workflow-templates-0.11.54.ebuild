...
RDEPEND="
	~dev-python/comfyui-workflow-templates-core-0.3.331[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-json-0.1.66[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-api-0.3.84[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-assets01-0.1.38[${PYTHON_SINGLE_USEDEP}]
