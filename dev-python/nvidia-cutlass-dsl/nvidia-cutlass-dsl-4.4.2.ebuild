...
"
SRC_URI="
	https://files.pythonhosted.org/packages/a9/03/678dab0383db1ddfc449da216220f40404189eb36eeed9d87a4fa4bdb0e6/${MY_WHEEL}
"
S="${WORKDIR}"
...
#
# 4.4.2 is preserved at upstream vllm 0.21.0's exact pin; 4.5.x is
# kept for newer consumers (cycle-aware bumping).
RDEPEND="
