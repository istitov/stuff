...
# normalises it to 26.8.0 (${PV}). librmm/VERSION carries the clean
# 26.08.00 string that scikit-build's regex version provider reads.
MY_PV="26.08.00"
...
# The C++ build pulls rapids-cmake (branch-26.08), CCCL and NVTX through
