...
"
# 0.6.15 is not on PyPI yet (the cubin package lags flashinfer-python);
...
SRC_URI="
	https://github.com/flashinfer-ai/flashinfer/releases/download/v${PV}/${MY_WHEEL}
"
S="${WORKDIR}"
...
# verified 2026-08-04 against 0.6.15.
