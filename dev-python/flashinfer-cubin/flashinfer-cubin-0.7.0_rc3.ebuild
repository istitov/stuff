...
# Map Gentoo's prerelease and patch suffixes to the wheel version.
MY_PV="${PV/_rc/rc}"
MY_PV="${MY_PV/_p/.post}"
...
"
# Versions after 0.6.13 are GitHub-only release wheels. rechecked 2026-09-19
SRC_URI="
...
# conservative redistribution restrictions. rechecked 2026-09-10
