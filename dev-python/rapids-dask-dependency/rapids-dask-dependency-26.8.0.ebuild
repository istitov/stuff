...
# normalises it to 26.8.0, which is our ${PV}.
MY_PV="26.08.00"
...
# (>=2026.7.1,<2026.7.2). That cap is NOT functionally load-bearing for
...
# 26.8.0 both patch entrypoints are no-ops
...
python_prepare_all() {
	# The release tag carries a dev-alpha version (26.08.00a0); RAPIDS CI
	# strips the suffix when cutting the final wheel. Restore the released
	# version so the built dist reports 26.8.0, not 26.8.0a0.
