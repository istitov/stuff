...
"
SRC_URI="
	python_targets_python3_12? ( ${MY_BASE}/e0/64/9d177e852192797bab0ecc7e9455a9c512c2c2b4b472da112cfeece00500/${MY_PN}-${PV}-cp312-cp312-manylinux_2_28_x86_64.whl )
	python_targets_python3_13? ( ${MY_BASE}/af/5c/4646abdac23e6a0057ebea2ef1e442ec7f354b886ef28d8432cba88fc4db/${MY_PN}-${PV}-cp313-cp313-manylinux_2_28_x86_64.whl )
	python_targets_python3_14? ( ${MY_BASE}/17/e9/b38d196c1e4503ea6dbd883b4f8778f0a6ca29b233807d14514049cc6066/${MY_PN}-${PV}-cp314-cp314-manylinux_2_28_x86_64.whl )
"
S="${WORKDIR}"
...
# the cu13 extra is enabled. # verified 2026-08-04 against 4.5.1.
RDEPEND="
