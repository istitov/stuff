...
# Preserve the dashed PyPI sdist name.
PYPI_NO_NORMALIZE=1
...
# Both modules import torch directly, while transformers does not enable its
# torch dependency by default. verified 2026-07-27
RDEPEND="
