...
SRC_URI="( x86? ( mirror://ubuntu/pool/main/f/firefox/firefox-globalmenu_${PV}+build1-0ubuntu1_i386.deb )
		 amd64? ( mirror://ubuntu/pool/main/f/firefox/firefox-globalmenu_${PV}+build1-0ubuntu1_amd64.deb )
		 )"
