...
src_install(){
  if use gtk2;then
	...
	dosym /usr/lib/liboverlay-scrollbar-0.2.so.0.0.11 /usr/lib/liboverlay-scrollbar-0.2.so.0 
  else
	insinto /usr/lib/
	doins os/.libs/liboverlay-scrollbar3-0.2.so.0.0.11
	dosym /usr/lib/liboverlay-scrollbar3-0.2.so.0.0.11 /usr/lib/liboverlay-scrollbar3-0.2.so.0 
  fi
