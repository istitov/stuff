...
src_configure() {
	...
	# app/toolbox.c stores 3-arg GtkItemFactoryEntry callbacks into a
	# generic void(*)(void) slot (the GtkItemFactory cast pattern). GCC
	# 15 promoted -Wincompatible-pointer-types to an error.
