...
inherit autotools python-any-r1 subversion xdg

DESCRIPTION="Framework for Scanning Mode Microscopy data analysis (3.x unstable)"
HOMEPAGE="https://gwyddion.net/"
ESVN_REPO_URI="https://svn.code.sf.net/p/gwyddion/code/branches/GWYDDION-UNSTABLE"
ESVN_PROJECT="gwyddion3-code"
...
src_prepare() {
	default
	cp "${BROOT}"/usr/share/gettext/config.rpath build-aux/ || die
...
pkg_postinst() {
	...
	elog "yet ported the binding to Python 3 / PyGObject, and gwyddion"
