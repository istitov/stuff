...
EGIT_BRANCH="alembic_pointcache"
# EGIT_COMMIT="v2.74"
...
IUSE_CODECS="+ffmpeg -dpx -dds openexr -tiff jpeg2k -redcode quicktime +avi"
IUSE_SYSTEM="+buildinfo +bullet fftw +openmp +opennl +sse2 -sndfile -jack sdl -openal +nls -ndof collada -doc -debug -valgrind -portable +lzo +hdf5 +freestyle +glew +gles X"
...
DEPEND="${PYTHON_DEPS}
	...
	ffmpeg? (
		media-video/ffmpeg[x264,xvid,mp3,encode]
		jpeg2k? ( media-video/ffmpeg[x264,xvid,mp3,encode,jpeg2k] )
	)
...
#	|| die
	...
	sed -e "/install_text_files_patch(/d" -i source/creator/CMakeLists.txt
...
src_configure() {
	append-flags -funsigned-char -fno-strict-aliasing -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -DHAVE_STDBOOL_H
	#append-lfs-flags
	local mycmakeargs=""
	...
	mycmakeargs+=(
		...
		$(cmake-utils_use_with glew SYSTEM_GLEW)
		...
		$(cmake-utils_use_with sdl GHOST_SDL)
