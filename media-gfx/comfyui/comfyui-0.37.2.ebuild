...
RDEPEND="${PYTHON_DEPS}
	...
	$(python_gen_cond_dep '
		~dev-python/comfy-aimdo-bin-0.5.5[${PYTHON_USEDEP},cuda=]
		~dev-python/comfy-kitchen-bin-0.2.35[${PYTHON_USEDEP},cuda=]
	...
	')
	templates? ( ~dev-python/comfyui-workflow-templates-0.11.69[${PYTHON_SINGLE_USEDEP}] )
	extra? (
...
PATCHES=(
	"${FILESDIR}/${PN}-0.35.1-optional-torchaudio.patch"
)
