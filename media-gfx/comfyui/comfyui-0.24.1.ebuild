...
RDEPEND="${PYTHON_DEPS}
	...
	~dev-python/comfyui-frontend-package-1.44.19[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-embedded-docs-0.5.2[${PYTHON_SINGLE_USEDEP}]
	$(python_gen_cond_dep '
	...
	')
	templates? ( ~dev-python/comfyui-workflow-templates-0.9.98[${PYTHON_SINGLE_USEDEP}] )
	extra? (
