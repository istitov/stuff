...
RDEPEND="${PYTHON_DEPS}
	...
	~dev-python/comfyui-frontend-package-1.45.15[${PYTHON_SINGLE_USEDEP}]
	~dev-python/comfyui-embedded-docs-0.5.4[${PYTHON_SINGLE_USEDEP}]
	$(python_gen_cond_dep '
	...
	')
	templates? ( ~dev-python/comfyui-workflow-templates-0.10.0[${PYTHON_SINGLE_USEDEP}] )
	extra? (
