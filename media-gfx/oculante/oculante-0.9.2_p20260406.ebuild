...
# Pin post-0.9.2 master for winit 0.30/wayland-client 0.31; the release's 0.29
# aborts on wl_shm v2 compositors. # verified 2026-07-11
...
src_configure() {
	# Bundled glslang declares a pre-3.5 floor rejected by CMake 4. Retain
	# glsl-to-spirv to avoid shaderc. # verified 2026-07-11 with CMake 4.3.4
	export CMAKE_POLICY_VERSION_MINIMUM=3.5

	# Disable self-update and its network/TLS stack; restore the other defaults
	# explicitly, substituting glsl-to-spirv for shaderc.
	local myfeatures=(
		turbo
		avif_native
		notan/glsl-to-spirv
