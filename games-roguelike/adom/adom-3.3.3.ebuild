...
SRC_URI="
x86? ( https://www.adom.de/home/download/current/${PN}_linux_debian_32_${PV}.tar.gz )
amd64? ( https://www.adom.de/home/download/current/${PN}_linux_debian_64_${PV}.tar.gz )
arm? ( https://www.adom.de/home/download/current/${PN}_linux_arm_${PV}.tar.gz )"
