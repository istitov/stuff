...
# verified 2026-07-28 (ollama 0.32.5 -> llama.cpp b10091, unchanged from 0.32.4;
# the 0.32.4..0.32.5 diff touches only MLX_VERSION and CI release.yaml).
LLAMACPP_COMMIT="b10091"
