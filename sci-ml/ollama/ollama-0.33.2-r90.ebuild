...
# verified 2026-08-29: v0.33.2's LLAMA_CPP_VERSION is still b10630, unchanged
# from 0.33.1, so the prestaged llama.cpp distfile is reused as-is.
LLAMACPP_COMMIT="b10630"
...
src_prepare() {
	...
	# added the include itself as of ~b10488 (the commit this ollama pins), so
	# guard on it to avoid a duplicate include -- and to keep applying it should
	# a future pin land on a tree that still lacks it. verified 2026-08-20
