...
RDEPEND="
	...
	dev-python/hf-transfer[${PYTHON_SINGLE_USEDEP}]
	dev-python/nest-asyncio[${PYTHON_SINGLE_USEDEP}]
	dev-python/numpy[${PYTHON_SINGLE_USEDEP}]
	dev-python/packaging[${PYTHON_SINGLE_USEDEP}]
	dev-python/protobuf[${PYTHON_SINGLE_USEDEP}]
	...
	>=dev-python/structlog-24.1[${PYTHON_SINGLE_USEDEP}]
	dev-python/tqdm[${PYTHON_SINGLE_USEDEP}]
	>=dev-python/triton-3[${PYTHON_SINGLE_USEDEP}]
	>=dev-python/typer-0.12[${PYTHON_SINGLE_USEDEP}]
	dev-python/tyro[${PYTHON_SINGLE_USEDEP}]
	>=dev-python/unsloth-zoo-2026.8.13[${PYTHON_SINGLE_USEDEP}]
	>=dev-python/wheel-0.42[${PYTHON_SINGLE_USEDEP}]
	...
	>=sci-ml/sentencepiece-0.2[${PYTHON_SINGLE_USEDEP}]
