...
src_prepare() {
	...
	# Version-named: upstream reflowed the comments around both call sites in
	# this tag, so the patch carried by older versions no longer applies.
