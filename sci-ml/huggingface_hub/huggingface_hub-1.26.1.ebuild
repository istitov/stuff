...
# click-8.4.2, hf_xet-1.5.2 and httpx-0.28.1-r1. The click floor is the one
# that matters and is mirrored, because upstream raised it to 8.4.2
# specifically to skip 8.4.0/8.4.1, which shipped a broken fish completion
# script. verified 2026-07-27
RDEPEND="
	$(python_gen_cond_dep '
		...
		>=sci-ml/hf_xet-1.5.1[${PYTHON_USEDEP}]
		torch? (
