...
# Mirror upstream's click, hf-xet, and httpx2 major caps. The click floor skips
# broken fish completions in 8.4.0/8.4.1; 2.0 raised hf-xet to 1.6.0 and moved
# the HTTP stack from httpx to httpx2. Verified 2026-09-24.
RDEPEND="
	$(python_gen_cond_dep '
		...
		>=sci-ml/hf_xet-1.6.0[${PYTHON_USEDEP}]
