...
# Upstream tag is v0.1.801-beta; the release asset spells the version with
# underscores (Unsloth-Desktop-0_1_801_beta-Ubuntu.deb).
MY_TAG="v${PV/_beta/-beta}"
MY_DEB="Unsloth-Desktop-${PV//./_}-Ubuntu.deb"
...
# below. verified 2026-08-23 against Unsloth-Desktop-0_1_801_beta.
