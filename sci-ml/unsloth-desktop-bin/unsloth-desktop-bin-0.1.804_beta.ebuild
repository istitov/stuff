...
# Upstream tag is v0.1.804-beta. Through 0.1.803-beta the release assets spelled
...
# so the unversioned upstream name is not a durability hazard. Re-check this on
# the next bump -- it is one release old and may not be settled convention.
# verified 2026-08-27 against v0.1.804-beta
...
# below. verified 2026-08-27 against Unsloth-Desktop-Ubuntu.deb (v0.1.804-beta).
