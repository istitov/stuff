...
# Upstream tag is v0.1.808-beta. Through 0.1.803-beta the release assets spelled
...
# now: it has held unchanged from 0.1.804-beta through 0.1.808-beta, across every
# platform asset. verified 2026-09-10 against v0.1.808-beta
...
# below. verified 2026-09-10 against Unsloth-Desktop-Ubuntu.deb (v0.1.808-beta).
