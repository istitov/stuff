...
# (therock.version), still 7.14.0 at 11.8.1 -- the 7.14 series is exactly
...
# bounds from that json on every bump. verified 2026-08-29 against 11.8.1
...
# verified 2026-08-29 against the 11.8.1 tarball.
RDEPEND="
	>=app-arch/zstd-1.5.5:=
	>=dev-cpp/cli11-2.4.2
...
src_prepare() {
	...
	# sed still matches either way. 11.7.0 keeps the v0.47.0 SHA pin and the
	# httplib FetchContent block unchanged. verified 2026-08-20 against 11.7.0
	sed -i \
