...
# Core install_requires per setup.py (verified against v0.20.0 sdist).
...
# torch<2.13 because of old-era openai-whisper transitive deps; verified
# 2026-06-04 the cap is stale (current openai-whisper has unbounded torch
...
# overlay yet; revisit once it lands. verified 2026-06-04 against
# v0.20.0.
RDEPEND="
	${PYTHON_DEPS}
