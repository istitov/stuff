...
pkg_postinst() {
	...
	elog "(dev-util/hip) and a supported AMD GPU. v6 is upstream's first"
	elog "stable release, but the project remains under heavy development and"
	elog "may not yet work for your particular CUDA application."
	elog ""
