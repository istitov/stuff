...
# 0.157.1: all 1,297 crates and the Cargo.lock set matched; the lock is
# unchanged from 0.157.0. RUSTY_V8_TAG=150.4.0 was re-derived from the upstream
# script. Verified 2026-09-26.
