...
# 0.157.0: all 1,297 crates and the Cargo.lock set matched. RUSTY_V8_TAG=150.4.0
# was re-derived from the lock and the upstream script; the crossterm fork
# moved to a new commit. Verified 2026-09-25.
...
PATCHES=( "${FILESDIR}/${PN}-0.156.1-chatgpt-recursion-limit.patch" )
