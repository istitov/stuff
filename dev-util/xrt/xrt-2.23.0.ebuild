...
if [[ ${PV} == 999999 ]] ; then
	...
	submodules["src/runtime_src/core/common/aiebu"]=https://github.com/Xilinx/aiebu.git@1e4470c9e0494cba13f869807e5036d5bc2fce7f
	...
	SRC_URI="
		https://github.com/Xilinx/XRT/archive/refs/tags/${MY_TAG}.tar.gz -> ${P}.tar.gz
