...
# the three load-bearing findings re-checked on 2.1.263 (2026-09-06): the
# DT_NEEDED set is unchanged, the external-ripgrep spawn path is still there,
# and there is still no vendored rg asset in the bunfs tree.
#
