...
src_unpack() {
	# rocm 7.2.3 release-asset tarballs unpack flat; restore the hipsparselt/,
	# origami/, hipblaslt/ wrapping directories the ebuild expects.
	mkdir -p "${WORKDIR}/hipsparselt" || die
	pushd "${WORKDIR}/hipsparselt" >/dev/null || die
