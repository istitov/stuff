...
# dropped at 0_pre829 and stays dropped. The gitlink has not moved since
# 0_pre841 -- 841, 845 and 849 all pin the same ggml e20c3a14 -- so the
# 2026-08-30 check against that exact tree carries over verbatim: zero
