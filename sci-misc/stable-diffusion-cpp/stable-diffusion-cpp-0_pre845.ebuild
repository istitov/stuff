...
# dropped at 0_pre829 and stays dropped. The gitlink did NOT move for this
# bump -- 0_pre841 and 0_pre845 pin the same ggml e20c3a14 -- so the 2026-08-30
# check against that exact tree carries over verbatim: zero
# GGML_HIP_ROCWMMA_FATTN occurrences, and the sole rocWMMA mention anywhere in
# the tree is a "TODO add support for AMD cards via rocWMMA" comment in
# ggml-cuda/lightning-indexer.cu, whose actual include is nvcuda::wmma via
# <mma.h> -- NVIDIA-only, carrying no rocWMMA dependency.
#
