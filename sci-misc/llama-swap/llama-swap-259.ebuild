...
src_compile() {
	...
	# !embed_ui supplies the no-UI implementation. At 259 the lockfile, output,
	# tag pair, and main.version ldflag target remain valid. The
	# cmd/kubeswap binary is not built here. # verified 2026-09-26
	local build_tags=()
	if use ui; then
