...
# BSD-2 and MIT cover the bundled cmark-gfm, which backs the Markdown reader.
LICENSE="AGPL-3 BSD-2 MIT"
SLOT="0/${PV}"
...
_emake() {
	...
	# compatibility on bumps (#685244). Keep the bundled cmark-gfm: md.c includes
	# its internal registry.h, which the system library does not install.
	# verified against 1.28.5 on 2026-09-26
	local myemakeargs=(
		GENTOO_PV=${PV}
