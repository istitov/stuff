...
SRC_URI="
	https://mirrors.ctan.org/systems/texlive/Source/texlive-${TL_VERSION}-source.tar.xz
	https://ftp.math.utah.edu/pub/tex/historic/systems/texlive/$(ver_cut 1)/texlive-${TL_VERSION}-source.tar.xz
	https://dev.gentoo.org/~flow/distfiles/texlive/texlive-${TL_VERSION}-source.tar.xz
"
