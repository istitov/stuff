...
OTTD_PV="${PV/_beta/-beta}" # Handle beta for SRC_URI
OTTD_PV="${PV/_rc/-RC}" # Handle release candidates SRC_URI
OTTD_P="${PN}-${OTTD_PV}"

DESCRIPTION="OpenTTD is a clone of Transport Tycoon Deluxe"
HOMEPAGE="http://www.openttd.org/"
SRC_URI="http://binaries.openttd.org/releases/${OTTD_PV}/${OTTD_P}-source.tar.gz"
