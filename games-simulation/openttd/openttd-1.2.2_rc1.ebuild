...
SRC_URI="http://binaries.openttd.org/releases/1.2.2-RC1/${PN}-1.2.2-RC1-source.tar.xz"
#http://binaries.openttd.org/releases/1.2.2-RC1/openttd-1.2.2-RC1-source.tar.xz
LICENSE="GPL-2"
SLOT="0"
