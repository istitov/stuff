...
# verified clean 2026-06-25 against gcc-16 + Boost-1.90 + Qt-5.15.19 +
# Python 3.13. The earlier HDF4-probe blocker (Gentoo bug 942866) is
...
# QtWebEngineWidgets usage in 6.15.0.4rc1 (this is the 6.15.0.4 stable), so
# the package is launchable on a Qt5-only Gentoo install — ::gentoo dropped
# PyQtWebEngine and dev-qt/qtwebengine:5 with its Qt5 deprecation.
#
